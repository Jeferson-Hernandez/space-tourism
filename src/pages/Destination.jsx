...
export const Destination = () => {
  ...
  return (
    <section className="h-screen overflow-x-hidden bg-destination-mobile md:bg-destination-tablet lg:bg-destination-desktop object-cover bg-cover bg-no-repeat py-24 md:py-32">
      ...
      <div className="text-center flex flex-col justify-center items-center space-y-10 md:space-y-10 lg:flex-row lg:space-y-0 lg:justify-evenly lg:pt-28 lg:text-start">
        ...
        <div className="flex flex-col space-y-7 justify-center items-center lg:items-start">
          <div className="flex flex-row space-x-10 font-barlow text-lightPurple text-[0.875rem] tracking-[0.14763rem] md:text-[1rem] md:tracking-[0.16875rem]">
            <a onClick={() => changePlanet("Moon")} href="#">
              MOON
            </a>
            <a onClick={() => changePlanet("Mars")} href="#">
              MARS
            </a>
            <a onClick={() => changePlanet("Europa")} href="#">
              EUROPA
            </a>
            <a onClick={() => changePlanet("Titan")} href="#">
              TITAN
            </a>
          </div>
          <div>
            ...
            <p className="text-[0.9375rem] leading-[1.5625rem] md:text-[1rem] lg:text-[1.125rem] md:leading-[1.75rem] font-barlow text-lightPurple lg:w-[27.75rem] lg:leading-[2rem] px-10 md:px-24 lg:px-0">
